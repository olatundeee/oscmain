...
<body>
    <div class="row">
        ...
        <div class="col-sm-4" style="border:1px solid #CCC; padding:4%; box-shadow:2px 2px 4px 4px #CCC;">
            <div align="">
        		<img src="https://<?php echo e(env('APP_URL')); ?>/img/<?php echo e($st->site_logo); ?>" style="height:100px; width:100px;" align="center">
        	</div>
...
</html><?php /**PATH /home/superloc/mcode.me/maxprofit.mcode.me/core/resources/views/mail/admin_approve_wd.blade.php ENDPATH**/ ?>