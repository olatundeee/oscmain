                                          ...
                                          <div class="row">
                                            <div class="col-lg-12">
                                                <div id="selfie" class="">
                                                  <div class="form-group" align="center">                                              
                                                    ...
                                                    <p class="text-warning " align="left">
                                                      Hold a paper clearly written "<?php echo e(strtoupper(env('APP_URL'))); ?>" <br> and take a selfie with it. Must show your full face and your arm raised.
                                                    </p>
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <p>
                                                    <?php echo e(__('Valid documents are: Country ID card, Passport and drivers Licence')); ?>
                                                ...
                                                <div class="form-group mt-4">                                              
                                                  ...
                                                  <select id="card_select" name="cardtype" class="form-control" required="required">
                                                    ...
                                                    <option value="idcard_op">ID Card</option>
                                                ...
                                                <div id="card_cont" class="cont_display_none">
                                                  <div class="form-group mt-3">                                              
                                                    ...
                                                    <br>
                                                    <img src="/img/id_temp_front.png" class="img_card_temp" >                                                 
                                                  ...
                                                  <div class="form-group mt-3">                                              
                                                    ...
                                                    <br>
                                                    <img src="/img/id_tem_bac.png" class="img_card_temp" >                                                   
                                          ...
                                          <div id="sec_enable_div" class="col-lg-12">
                                            <div class="form-group ">
                                              ...
                                              <div class="btn-group btn-group-toggle btn-lg p-0 ">
                                                <label class="btn <?php if($user->sec_2fa_status == 1): ?><?php echo e(__('btn-success')); ?><?php else: ?><?php echo e(__('btn_grey')); ?><?php endif; ?> text-white" onclick="s_2fa('enable')">
                                                  <input type="radio" name="options" autocomplete="off" > Enable
                                                </label>                                                    
                                                <label class="btn <?php if($user->sec_2fa_status == 1): ?><?php echo e(__('btn_grey')); ?><?php else: ?><?php echo e(__('btn-success')); ?><?php endif; ?>" onclick="s_2fa('disable')">
