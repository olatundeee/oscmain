                            ...
                            <div class="card">
                                <div class="card-header card_header_bg_blue" >
                                    <div class="card-head-row card-tools-still-right">
                                        <h4 class="card-title text-white"> <?php echo e(__('Search')); ?> User Activities</h4>
                                    ...
                                    <div class="row pad_top_20">
                                        <div class="col-lg-6">
                                            <div class="form-group" align="center">
                                                <?php if($user->img == ""): ?>
                                                    <img class="img-responsive" src="/img/any.png" width="100%" >
                                                <?php else: ?>
                                                    <img class="img-responsive" src="/img/profile/<?php echo e($user->img); ?>" width="100%" >
                                                <?php endif; ?>
                                            </div>
                                        </div>  
                                        <div class="col-lg-6">
...
<?php echo $__env->make('admin.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/superloc/mcode.me/maxprofit.mcode.me/core/resources/views/admin/user_details.blade.php ENDPATH**/ ?>