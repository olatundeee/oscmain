        ...
        <div class="datatable-dashv1-list custom-datatable-overright dashtwo-project-list-data">
            <form action="/admin/addNew/admin" method="post">
              ...
              <div class="form-group">
                <br>
                  <button class="collb btn btn-info"><?php echo e(__('Add')); ?></button>
                  <br>
              </div>              
            </form>
        </div>
    </div>
</div><?php /**PATH /home/superloc/mcode.me/maxprofit.mcode.me/core/resources/views/admin/temp/add_new_admin.blade.php ENDPATH**/ ?>