                            ...
                            <div class="row "> 
                              ...
                              <div   class="col-md-6 ">
                                  <div class="card pad_20">
                                      ...
                                      <div class="form-group">
                                          <h5> <?php echo e(__('Mail Sender. (Installation URL name without http:// or https://)')); ?> </h5>
...
<?php echo $__env->make('admin.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/davibwfs/public_html/OVest/Vault/core/resources/views/admin/settings.blade.php ENDPATH**/ ?>